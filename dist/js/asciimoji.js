...
var dictionary = {
  ...
  bunny: { words: ["bunny", "bunbun", "rabbit"], ascii: "૮(„• ༝ •„)ა" },
  ...
  fuckyou: { words: ["fuckyou", "fu"], ascii: "ᶠᶸᶜᵏ♥ᵧₒᵤ" },
  ...
  hug: { words: ["hug"], ascii: "(っ◕‿◕)っ" },
  // hugs: { words: ["hugs"], ascii: "(づ｡◕‿‿◕｡)づ" },
